...
class wall():
	def __init__(self):
		...
		self.height = screen_height // rows // 2
	...
	def create_wall(self):
		...
		for row in range(rows):
			...
			#append to row to the full list of blocks
...
class paddle():
	...
	def reset(self):
		self.height = int(screen_height / rows // 5)
...
while run:
	...
	if not live_ball:
		if game_over == 0:
			draw_text("CLICK ANYWHERE TO START", font, text_col, 100, screen_width // 2 + 100)
		elif game_over == 1:
			draw_text("YOU WON!", font, text_col, 240, screen_width // 2 + 50)
			draw_text("CLICK ANYWHERE TO START", font, text_col, 100, screen_width // 2 + 100)
		elif game_over == -1:
			draw_text("YOU LOST!", font, text_col, 240, screen_width // 2 + 50)
			draw_text("CLICK ANYWHERE TO START", font, text_col, 100, screen_width // 2 + 100)
